from bot.helpers import SmartButtons
from ..config import UPDATE_CHANNEL_URL
from pyrogram.enums import ParseMode

main_menu = SmartButtons()
main_menu.button("AI Tools", callback_data="ai_tools")
main_menu.button("CC Tools", callback_data="credit_cards")
main_menu.button("Crypto", callback_data="crypto")
main_menu.button("Converter", callback_data="converter")
main_menu.button("Coupons", callback_data="coupons")
main_menu.button("Decoders", callback_data="decoders")
main_menu.button("Downloaders", callback_data="downloaders")
main_menu.button("Domain Check", callback_data="domain_check")
main_menu.button("Education Utils", callback_data="education_utils")
main_menu.button("Editing Utils", callback_data="rembg")
main_menu.button("Next ➡️", callback_data="next_1")
main_menu.button("Close ❌", callback_data="close")
main_menu_keyboard = main_menu.build_menu(b_cols=2)

second_menu = SmartButtons()
second_menu.button("File To Link", callback_data="file_to_link")
second_menu.button("Github Utils", callback_data="github")
second_menu.button("Info", callback_data="info")
second_menu.button("Network Tools", callback_data="network_tools")
second_menu.button("Random Address", callback_data="random_address")
second_menu.button("String Session", callback_data="string_session")
second_menu.button("Stripe Keys", callback_data="stripe_keys")
second_menu.button("Sticker", callback_data="sticker")
second_menu.button("Time Date", callback_data="time_date")
second_menu.button("Txt Spilt", callback_data="text_split")
second_menu.button("Previous ⬅️", callback_data="previous_1")
second_menu.button("Next ➡️", callback_data="next_2")
second_menu.button("Close ❌", callback_data="close")
second_menu_keyboard = second_menu.build_menu(b_cols=2)

third_menu = SmartButtons()
third_menu.button("Temp Mail", callback_data="tempmail")
third_menu.button("Text OCR", callback_data="text_ocr")
third_menu.button("User Export", callback_data="bot_users_export")
third_menu.button("Web Capture", callback_data="web_capture")
third_menu.button("Weather", callback_data="weather")
third_menu.button("Yt Tools", callback_data="yt_tools")
third_menu.button("Translate", callback_data="translate")
third_menu.button("Previous ⬅️", callback_data="previous_2")
third_menu.button("Close ❌", callback_data="close")
third_menu_keyboard = third_menu.build_menu(b_cols=2)
...
responses = {
    ...
    "string_session": (
        ...
        "➢ <b>/pyro</b> - Generate a Pyrogram string session.\n"
        " - Example: <code>/pyro</code> (Starts the process to generate a Pyrogram string session)\n\n"
        "➢ <b>/tele</b> - Generate a Telethon string session.\n"
